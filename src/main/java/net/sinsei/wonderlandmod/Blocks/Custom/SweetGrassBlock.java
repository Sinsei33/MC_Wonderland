...
import net.sinsei.wonderlandmod.Blocks.Blocktypes.SpreadingSweetGrassBlock;
...
public class SweetGrassBlock extends SpreadingSweetGrassBlock implements BonemealableBlock
{
    public SweetGrassBlock(BlockBehaviour.Properties p_53685_) {
        super(p_53685_);
    }
    ...
    // Todo Bonemeal Plants
    public void performBonemeal(ServerLevel p_221270_, RandomSource p_221271_, BlockPos p_221272_, BlockState p_221273_) {
        BlockPos blockpos = p_221272_.above();
        BlockState blockstate = ModBlocks.SWEET_GRASS_BLOCK.get().defaultBlockState();
