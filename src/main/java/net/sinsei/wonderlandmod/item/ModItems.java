...
public class ModItems {
    ...
    public static final RegistryObject<Item> CAKE_SEEDS_ITEM = ITEMS.register("cake_seeds_item", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CHOCOLATE_ITEM = ITEMS.register("chocolate_item", () -> new Item(new Item.Properties()));
